    ...
    <section className="pt-32 pb-16 flex flex-col items-center text-center">
      <motion.div initial={{ y: 20, opacity: 0 }} animate={{ y: 0, opacity: 1 }} transition={{ duration: 0.6 }}>
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
          <Link href="/planos" className="bg-yellow-400 hover:bg-yellow-500 text-black font-black rounded-xl px-10 h-14 text-lg transition-transform hover:scale-105 shadow-[0_0_30px_rgba(234,179,8,0.2)] flex items-center justify-center w-full sm:w-auto">
            Começar Teste Grátis
          </Link>
          <Link href="#como-funciona" className="border border-white/10 text-white hover:bg-white/5 rounded-xl px-10 h-14 text-lg font-bold transition-all flex items-center justify-center w-full sm:w-auto">
            Ver Como Funciona
          </Link>
        </div>
    ...
    <section className="py-12">
      <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
        {[
          ...
          <div key={i} className="bg-[#09090b] border border-white/5 p-6 rounded-3xl text-center">
    ...
    <section id="como-funciona" className="py-20 scroll-mt-24 border-t border-white/5">
      ...
      <div className="grid md:grid-cols-3 gap-8">
        {[
          ...
          <div key={index} className="bg-[#09090b] border border-white/5 p-8 rounded-3xl relative">
          ...
          return (
            ...
            >
              <div className="flex items-center justify-between gap-4">
                ...
                <span className={`text-yellow-400 font-bold transition-transform duration-300 ${isOpen ? "rotate-180" : ""}`}>
                  ▼
                </span>
              </div>
              {isOpen && (
...
function FinalCTA() {
  return (
    <section className="py-20 text-center border-t border-white/5">
      <div className="bg-gradient-to-b from-yellow-500/10 to-transparent border border-yellow-500/20 rounded-[32px] p-12 relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-2xl mx-auto">
          ...
          <Link href="/planos" className="bg-yellow-400 hover:bg-yellow-500 text-black font-black rounded-xl px-10 h-14 text-lg transition-transform hover:scale-105 shadow-[0_0_30px_rgba(234,179,8,0.3)] inline-flex items-center justify-center">
