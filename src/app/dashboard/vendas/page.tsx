...
export default function SalesPage() {
  ...
  // Lógica de filtro real atrelada ao input de busca
        ...
        <div className="p-8 border-b border-white/5 flex flex-col md:flex-row justify-between items-center gap-4">
          ...
          <div className="relative w-full md:w-64">
            ...
            <input 
              ...
              className="w-full bg-black border border-white/10 rounded-2xl py-4 pl-12 pr-4 text-xs focus:border-emerald-500 outline-none text-white font-medium"
            />
          </div>
        </div>
