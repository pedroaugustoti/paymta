  ...
  return (
    <div className="bg-[#0a0a0a] border border-white/5 p-8 rounded-3xl shadow-[0_0_40px_rgba(0,0,0,0.5)] transform-gpu relative z-20">
      <div className="text-center mb-8">
        <h2 className="text-xl font-bold text-white mb-1">Acessar Painel</h2>
        <p className="text-sm text-zinc-500">Gerencie suas vendas e servidores.</p>
      </div>
      ...
      <form onSubmit={handleLogin} className="space-y-4">
        ...
        <div className="space-y-1.5">
          ...
          <div className="flex justify-end pt-1">
            <Link href="/auth/recover" className="text-xs text-green-500 hover:text-green-400 font-medium transition-colors">
              Esqueceu a senha?
            </Link>
          </div>
        </div>
      ...
      <p className="text-center text-sm text-zinc-500 mt-8 pt-6 border-t border-white/5">
        Não tem uma conta?{' '}
        <Link href="/auth/register" className="text-green-500 hover:text-green-400 font-bold transition-colors">
          Cadastre-se grátis
        </Link>
      </p>
    </div>
